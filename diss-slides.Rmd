...
- Examine power when I know true eQTL locations

    - Interlocus distance    
    - Univariate LOD    

- 80 local eQTL on Chr 19 (LOD > 7.2)
...
# Power study: Interlocus distance

```{r, out.height = "500px"}
include_graphics("../keller-2018-chr19-power/Rmd/lrt-v-middle-of-gene.svg", auto_pdf = FALSE)
```
...
# Power study: Univariate LOD

```{r, out.height="500px"}
include_graphics("../keller-2018-chr19-power/Rmd/lrt-v-univariate-lod.svg", auto_pdf = FALSE)
```
